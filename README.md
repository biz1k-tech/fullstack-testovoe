...
1. Установить строку подключения в appsettings.json для бека:
  ```
файл находится в : fullstack-testovoe\src\Backend\Api
  ```
2. Сделать миграции
   ```
...
4. Вставить порты апи для фронта в два файла appsettings.json
   ```
   файл находится в : 
   fullstack-testovoe\src\Frontend\Web
   fullstack-testovoe\src\Frontend\Web.Client\wwwroot
   ```
5. Перейти в директорию проекта и выполнить команду:
   ```
